...
public class AddBlood extends AppCompatActivity implements BloodApiCallBack {
    ...
    public void PostBlood(Integer s,Integer d) {
        ...
        RestAPIManager.getInstance().postBlood(new Blood(("9000-07-22T15:35:00.000Z"),Integer.parseInt(systolic.getText().toString()),Integer.parseInt(diastolic.getText().toString()),LoginActivity.user),this);
